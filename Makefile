#############################################################################
# Makefile for building: nettruyen
# Generated by qmake (3.1) (Qt 5.15.14)
# Project:  nettruyen.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile nettruyen.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = nettruyen1.0.0
DISTDIR = /home/niyaki/Music/nettruyen/.tmp/nettruyen1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=4 -fno-fat-lto-objects -fuse-linker-plugin -Wl,-rpath-link,/usr/lib -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		nettruyen.pro  main.cpp
QMAKE_TARGET  = nettruyen
DESTDIR       = 
TARGET        = nettruyen
...
Makefile: nettruyen.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		nettruyen.pro
	$(QMAKE) -o Makefile nettruyen.pro
